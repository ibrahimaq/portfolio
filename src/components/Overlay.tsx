...
const Overlay = () => {
	const { overlay, setOverlay, formIsSubmitted, setFormIsSubmitted, color } = useGlobalContext();
			...
			transition((style, item) => item && (
				...
				>
					<div className="p-[20px] flex flex-row justify-end sticky top-0 bg-white rounded-tr-xl rounded-tl-xl">
						...
						>
							<IconContext.Provider value={{ className: `w-[32px] h-[32px] ${themeClassBuilder({ color, el: 'text' })}` }}>
