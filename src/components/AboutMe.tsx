...
const AboutMe = () => {
  ...
  const pStyle = `text-2xl font-light transition-all duration-500 ${
    ...
    <section className="py-20">
      <Container className="flex flex-col md:flex-row md:justify-between">
        ...
        `}>About</h2> */}
          ...
          <p className={`${pStyle} mt-5`} ref={textRef}>
            I&apos;m a Maths teacher turned web developer. I&apos;ve brought my
            love for learning and problem-solving into the world of web
            development.
          </p>

          <p className={`${pStyle} my-5 delay-[200ms]`}>
            I&apos;m addicted to building stylish, modern websites and web
            applications.
          </p>

          <p className={`${pStyle} delay-[400ms]`}>
            Let&apos;s collaborate on your next project and bring some serious
            web magic to life!
          </p>
        </div>
        ...
        <div className="w-full md:w-1/2 h-full flex justify-center md:justify-end pr-[64px] mt-12 md:mt-0">
          <div
            ref={imgRef}
            className="relative max-w-[300px] md:min-w-[250px] lg:min-w-[300px] flex justify-center"
          >
            <StaticImage
          ...
          ${
            imgInView
              ? "opacity-100 top-[40px] left-[70px]"
