    ...
    <section className="relative -mt-[76px] md:mt-0 min-h-[800px] pt-28">
      ...
      <Container className="pt-28 md:pt-24 relative">
        <div className="flex flex-col items-center">
          <h1 className="text-5xl md:text-6xl max-w-[1000px] text-center">
            {headingTopLine && (
              <span
                className={`${themeClassBuilder({
                  color,
                  el: "text",
                })} tracking-wide`}
              >
          ...
          {bodyCopy && (
            <p className="text-2xl md:text-2xl text-dark font-light text-center my-5 md:my-8 tracking-wider max-w-[800px]">
              {bodyCopy}
            </p>
          )}
          <div>
